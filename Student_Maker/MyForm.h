...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->monthCalendar1->SelectionRange = (gcnew System::Windows::Forms::SelectionRange(System::DateTime(2019, 10, 1, 0, 0, 0, 0), System::DateTime(2019,
				10, 7, 0, 0, 0, 0)));
			this->monthCalendar1->TabIndex = 35;
			this->monthCalendar1->TitleBackColor = System::Drawing::SystemColors::ControlLightLight;
			this->monthCalendar1->TodayDate = System::DateTime(2019, 10, 1, 0, 0, 0, 0);
			// 
			// listBox1
			// 
